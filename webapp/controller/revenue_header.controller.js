sap.ui.define([
  ...
  return Controller.extend("sierra.pra.PRA_Custom.controller.revenue_header", {
    ...
    onSelectChange: function() {
      var filterValues = [];
      filterValues.push(this.getSelectedItemText(this.oSelectName));
      filterValues.push(this.getSelectedItemText(this.oSelectCategory));
      filterValues.push(this.getSelectedItemText(this.oSelectSupplierName));
      filterValues.push(this.getSelectedItemText(this.oSelectVenture));
      filterValues.push(this.getSelectedItemText(this.oSelectWell));
      this.filterTable(filterValues);
    },
    filterTable: function(filterValues) {
      this.getTableItems().filter(this.getFilters(filterValues));
      this.updateFilterCriterias(this.getFilterCriteria(filterValues));
    },
    ...
    getFilters: function(filterValues) {
      this.aFilters = this.aKeys.map(function(key, idx) {
        return new Filter(key, FilterOperator.Contains, filterValues[idx]);
      });
      return this.aFilters;
    },
    getFilterCriteria: function(filterValues) {
